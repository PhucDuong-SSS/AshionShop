			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-6 col-sm-6">
					<div class="cart__btn update__btn">
						<span class="icon_loading"></span> <input name="submit" style=" border: transparent; background-color:#F5F5F5;color:#111111;font-weight:600; height:45px" type="submit" value="Update value">
					</div>
				</div>
			</div>
		</form>
		<div class="row">
			...
			<div class="col-lg-4 offset-lg-2">
				<div class="cart__total__procced">
					<h6>Cart total</h6>
					<ul>
						<li>Subtotal <span>$ <?= $fm->format_currency($subtotal)??0 ?></span></li>
