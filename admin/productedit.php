         ...
         <form action="" method="post" enctype="multipart/form-data">
            <table class="form">
                ...
                <tr>
                    ...
                    <td>
                        <select id="select" name="istrend">
                            <option>Select Type</option>
                            <?php 
                            if ($result_product['istrend'] ==0) {
                             ?>
                            <option selected value="0">No trend</option>
                ...
                <tr>
                    <td>
                        <label>Product gender</label></label>
                    </td>
                    <td>
                        <select id="select" name="gender">
                            <option>Select Type</option>
                            <?php 
                            if ($result_product['product_gender'] ==0) {
                             ?>
                ...
                <tr>
                    ...
                    <td>
                        <select id="select" name="show">
                            <option>Select Type</option>
                            <?php 
                            if ($result_product['product_show'] ==0) {
                             ?>
                            <option selected value="0">Not show</option>
